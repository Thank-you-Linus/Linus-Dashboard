...
class DynamicEntityManager:
    ...
    def __init__(
        ...
        create_entities_callback: Callable[
            [str, str], Awaitable[list[Any]] | list[Any]
        ],
    ...
    async def async_setup(self) -> None:
        ...
        if self._startup_complete:
            ...
            _LOGGER.debug(
                "%s: HA running, skipping post-startup refresh", self._platform_name
            )
        else:
        ...
        def _entity_registry_updated(event: Event) -> None:
            ...
            self.hass.async_create_task(self._async_create_entities_for_area(area_id))
