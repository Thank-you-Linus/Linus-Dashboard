...
CONF_ALARM_ENTITIES = "alarm_entities"  # Liste d'alarmes
CONF_ALARM_ENTITY_IDS = "alarm_entity_ids"  # Liste d'IDs d'alarmes
...
CONF_EXCLUDED_INTEGRATIONS = "excluded_integrations"  # Intégrations à exclure
