# 🚀 Quick Start Guide - 5 Minutes to Your Perfect Dashboard
...
### Get Linus Dashboard Running in 5 Minutes

Follow these simple steps to transform your Home Assistant with automatic organization.
...
1. Download the [latest release](https://github.com/Thank-you-Linus/Linus-Dashboard/releases)
...
4. Click on **Linus Dashboard** in the results
5. **(Optional)** Select a weather entity
6. **(Optional)** Select an alarm entity
7. Click **Submit**

---

## Step 3: Access Your Dashboard (1 minute)

1. Look for the **bowtie icon 🎀** in your left sidebar
2. Click it to open Linus Dashboard
3. **Explore your auto-organized smart home!**

All your devices are automatically organized by room and type. No configuration needed.
...
### Linus Dashboard Opérationnel en 5 Minutes

Suivez ces étapes simples pour transformer votre Home Assistant avec l'organisation automatique.
...
1. Téléchargez la [dernière version](https://github.com/Thank-you-Linus/Linus-Dashboard/releases)
2. Extrayez dans `custom_components/linus_dashboard/`
...
4. Cliquez sur **Linus Dashboard** dans les résultats
5. **(Optionnel)** Sélectionnez une entité météo
6. **(Optionnel)** Sélectionnez une entité alarme
7. Cliquez sur **Valider**

---

## Étape 3 : Accédez à Votre Tableau de Bord (1 minute)

1. Cherchez **l'icône nœud papillon 🎀** dans la barre latérale gauche
2. Cliquez dessus pour ouvrir Linus Dashboard
3. **Explorez votre maison intelligente auto-organisée !**

Tous vos appareils sont automatiquement organisés par pièce et type. Aucune configuration nécessaire.
