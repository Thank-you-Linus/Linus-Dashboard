...
export namespace chips {
  export type AggregateChipOptions = { magic_device_id?: string, device_class: string } & SensorChipOptions;
  export type SensorChipOptions = { device_class?: string } & ChipOptions;
  export type ChipOptions = { area_slug?: string | string[], floor_id?: string, show_content?: boolean } & TemplateChipOptions;
